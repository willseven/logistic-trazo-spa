...
import { columnsManageStepProcedure } from './columnsManageStepProcedures';
...
export const TableStepProcedure = (props: { data: IManageProcedure[]}) => {
  const { data } = props;
  const columns = columnsManageStepProcedure;
